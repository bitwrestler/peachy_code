...
from ServerCommon import LISTEN_IF_PORT,DEFAULT_MAX_LEN,DEFAULT_BATCH_SIZE
from llama import Llama
from collections import namedtuple

ServerParams = namedtuple('ServerParams',['LLM_DIR','LLM_RELATIVE_DIR','TOKENIZER_MODEL_FILE','SEQ_LEN','MAX_BATCH_SIZE'], 
                          defaults=[None,'llm_model','tokenizer.model',DEFAULT_MAX_LEN,DEFAULT_BATCH_SIZE])
...
if __name__ == "__main__":
    server_params = ServerParams(os.path.realpath(__file__))
